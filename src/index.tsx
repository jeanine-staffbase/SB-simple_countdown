...
import { MyWidgetProps, MyWidget } from "./my-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  return class MyWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): MyWidgetProps {
      const attrs = this.parseAttributes<MyWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<MyWidget {...this.props} />, container);
    }
